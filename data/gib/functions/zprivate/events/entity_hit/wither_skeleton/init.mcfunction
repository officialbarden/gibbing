...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.WITHER_SKELETON
...
function gib:zprivate/events/entity_hit/wither_skeleton/randomize with storage gib:storage MACRO.GIB

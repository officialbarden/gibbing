...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.SKELETON
...
function gib:zprivate/events/entity_hit/skeleton/randomize with storage gib:storage MACRO.GIB

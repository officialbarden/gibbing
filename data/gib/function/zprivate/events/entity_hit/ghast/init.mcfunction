...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.GHAST
...
function gib:zprivate/events/entity_hit/ghast/randomize with storage gib:storage MACRO.GIB

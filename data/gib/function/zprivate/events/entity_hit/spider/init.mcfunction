...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.SPIDER
...
function gib:zprivate/events/entity_hit/spider/randomize with storage gib:storage MACRO.GIB

...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.CREEPER
...
function gib:zprivate/events/entity_hit/creeper/randomize with storage gib:storage MACRO.GIB

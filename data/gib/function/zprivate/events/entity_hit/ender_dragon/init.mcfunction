...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.ENDER_DRAGON
...
function gib:zprivate/events/entity_hit/ender_dragon/randomize with storage gib:storage MACRO.GIB

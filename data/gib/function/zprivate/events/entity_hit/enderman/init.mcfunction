...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.ENDERMAN
...
function gib:zprivate/events/entity_hit/enderman/randomize with storage gib:storage MACRO.GIB

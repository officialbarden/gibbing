...
execute store result score #len gib.CONFIG run data get storage gib:storage GIB.BLOCKS.MOB_HIT.ZOMBIE
...
function gib:zprivate/events/entity_hit/zombie/randomize with storage gib:storage MACRO.GIB
